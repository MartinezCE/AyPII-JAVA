package LeerArchivoYArraysDeString;
import java.io.*;


public class LeerUsarSplit {


	public static void main(String args[]){
		try{
			FileReader input = new FileReader(new File("/Users/cristianmartinez/Desktop/Archivos/miArchivo.txt"));
