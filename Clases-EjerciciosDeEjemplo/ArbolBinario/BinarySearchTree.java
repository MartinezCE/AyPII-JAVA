...
import Ejercicio05.BinaryNode;
import Ejercicio05.ItemNotFoundException;
import Ejercicio05.T;
...
public class BinarySearchTree<T extends Comparable<? super T>>
{
 ...
 protected BinaryNode<T> obtenerMaximo( BinaryNode<T> elemento )
 {
     if( elemento == null ) {
         throw new Error( );
         }
     else if( elemento.right != null && elemento < elemento.right){
     
         elemento = obtenerMaximo( elemento.right );
         return elemento;
     }
     else
         return null;
